          ...
          <div className="hero d-flex align-items-center justify-content-center">
            <div className="container-fluid">
              <div className="text-center">
                ...
                <p>
                  At Silva Builders Builders, we are a team of skilled
                  professionals dedicated to delivering exceptional construction
                  solutions.<br></br>With years of experience and a passion for
                  quality, we bring your visions to life with precision,
        ...
        <section className="section-4">
          <div className="container py-5">
            <div className="service-header text-center">
              ...
              <p>
                Experience the difference with Silva Builders. Our commitment to
                ...
                <div className="card shadow border-0 p-4">
                  ...
                  <div className="card-body">
                    ...
                    <p>
                      ...
                      experience to every project, ensuring your vision is
              ...
              <div className="col-md-4">
                <div className="card shadow border-0 p-4">
                  ...
                  <div className="card-body">
                    ...
                    <p>
                      We stay advanced with cutting-edge technologies and
                      innovative approaches, ensuring your project is at the
                ...
                <div className="card shadow border-0 p-4">
                  ...
                  <div className="card-body">
                    ...
                    <p>
                      ...
                      listen to your needs and deliver results that exceed your
                      expectations.
                    </p>
                  </div>
                </div>
                      ...
                      <div className="d-flex meta">
                        ...
                        <div>
                          <div className="ps-3">
                            ...
                            <div className="designation">CEO, Company Name</div>
                          </div>
                        </div>
                      </div>
                    </div>
